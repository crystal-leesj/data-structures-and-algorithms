...
public class RepeatedWordTest {
    @Test
    public void testRepeatedWord_short() {
        String inputString = "Once upon a time, there was a brave princess who...";
        String actual = RepeatedWord.getRepeatedWord(inputString);
        assertEquals("a", actual);
    }

    @Test
    public void testRepeatedWord_caseSensitive() {
    ...
    @Test
    public void testRepeatedWord_sameMaxValues() {
